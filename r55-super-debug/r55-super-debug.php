 ...
 class R55_Super_Debug_Tool {
     ...
     public function display_debug_information() {
         if ( is_single() && defined( 'WP_DEBUG' ) && WP_DEBUG && isset( $_GET['debugtool'] ) ) {
             ...
             // Collect debug information (same as before)...
     ...
     public function render_settings_page() {
         ...
         <div class="wrap">
             ...
             <p>
                 ...
                 Issues and PR's may be submitted via <a href="https://github.com/rocket55dev/r55-super-debug-tool" target="_blank">GitHub</a>.
             </p>
     ...
     /**
      * Callback function for the "Load Bootstrap Assets" setting field.
      */
     public function load_bootstrap_field_callback() {
         $option = get_option( 'r55_debug_tool_load_bootstrap', 'yes' );
         ?>
         <label>
             <input type="checkbox" name="r55_debug_tool_load_bootstrap" value="yes" <?php checked( 'yes', $option ); ?>>
             Enable loading of Bootstrap assets
         </label>
         <?php
     }
